...
private:
	...
	void CreateGraphicsPipeline() {
		auto vertShaderCode = readFile("F:/Lithium-Universe/Resources/vert.spv");
		auto fragShaderCode = readFile("F:/Lithium-Universe/Resources/frag.spv");
	...
	void CreateTextures() {
		...
		CreateImage(texWidth, texHeight, MipLevels, VK_SAMPLE_COUNT_1_BIT,
			VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
